...
\icmltitlerunning{Protein sequence identification with Wasserstein Autoencoders}

\begin{document}

\twocolumn[
\icmltitle{Protein sequence identification with Wasserstein Autoencoders}

% It is OKAY to include author information, even for blind
% submissions: the style file will automatically remove it for you
% unless you've provided the [accepted] option to the icml2016
% package.
\icmlauthor{Basile Dura}{basile.dura@umontreal.ca}
\icmladdress{UdeM}
\icmlauthor{Julien Horwood}{julien.horwood@umontreal.ca}
\icmladdress{UdeM}
\icmlauthor{Nicolas Bélanger}{nicolas.belanger@umontreal.ca}
\icmladdress{UdeM}
